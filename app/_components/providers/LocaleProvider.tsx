...
const translations = {
  en: {
    ...
    auth: {
      ...
      cnic_placeholder: "e.g. 35201-1234567-8",
      address: "City / Address",
      address_placeholder: "e.g. Lahore, Punjab",
      patient_details: "Patient Details (required for appointments)",
    },
    dashboard: {
  ...
  ur: {
    ...
    auth: {
      ...
      cnic_placeholder: "مثلاً 35201-1234567-8",
      address: "شہر / پتہ",
      address_placeholder: "مثلاً لاہور، پنجاب",
      patient_details: "مریض کی تفصیلات (ملاقاتوں کے لیے ضروری)",
    },
    dashboard: {
      welcome: "خوش آمدید",
      overview: "جائزہ",
